...
public class DonorController {
	...
	public ResponseEntity<DonorDtoResponse> save(@PathVariable(value = "ngoId") Long id, @Valid @RequestBody DonorDtoSaveUpdate donor){
		return new ResponseEntity<DonorDtoResponse>(donorService.save(id, donor), HttpStatus.CREATED);
	}
}
